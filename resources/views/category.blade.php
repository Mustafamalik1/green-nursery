...
<html class="" lang="en">
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <div class="modal-title f_13 ">Product successfully added to your shopping cart</div>
               ...
               <div class="modal-body">
                  <div class="row">
                     ...
                     <div class="col-sm-8 col-xs-12 ">
                        <h6 class="">Hummingbird printed t-shirt</h6>
                        <div class=" pb-1">$19.12</div>
                        <span class=" f_13 pb-1">Size: S</span><br>
                        <span class=" f_13 pb-1">Color: White</span><br>
                        <span class=" f_13 pb-1">Qty: 2</span>
                     </div>
                  </div>
                  <div class="row">
                     <div class=" col-12 ">
                        <div class="border rounded final_payment">
                           <div class="card-body  border-bottom">
                              ...
                              <p class="er">show details</p>
                              <div>
                                 <span class="">subtotal</span>
                                 <span class="float-right ">$94.00</span>
                              </div>
                              <div>
                                 <span class="">shipping</span>
                                 <span class="float-right ">$9.00</span>
                              </div>
                           </div>
                           <div class="card-body ">
                              <div>
                                 <span class="">total(tax excl.)</span>
                                 <span class="float-right ">$94.00</span>
                              </div>
                           </div>
                        </div>
               ...
               <div class="modal-body">
                  <div class="row">
                     ...
                     <div class="col-sm-7 col-12">
                        ...
                        <div class=" border-bottom me_price">$19.12</div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body text-center">
                  ...
                  <p class="text-muted ">Product successfully removed from the product comparison!</p>
                  <div class="text-danger ">Go to Compare</div>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body text-center">
                  ...
                  <p class="text-muted ">You must be logged in to manage your wishlist.</p>
                  <div class="text-danger ">Go to wishlist</div>
               </div>
            </div>
         </div>
      </div>
 ...
 <!-- header area -->
         ...
         <div class="row ">
            <div class="col-lg-3 vertical_menu">
               <div class="v_menu bg-white rounded">
                  <div class="cat_menu bg-warning rounded-top"><a href="#" class="pe-auto text-uppercase d-md-none d-sm-none d-none d-lg-block "><i class="fas fa-bars"></i>all categories</a></div>
   ...
   <div id="category_style_page" class="category-style-page animate__animated animate__fadeInUp">
      ...
      <div class="sp_header bg-white p-3 ">
         <div class="container custom_container "> 
            <div class="row ">
               <div class="col-12 ">
                  <ul>
                     <li class="d-inline-block er"><a href="index.html">home</a></li>
                     <li class="d-inline-block hr_ er"><a href="#">category</a></li>
                  </ul>
               </div>
            </div>
         </div>
      ...
      <div class="container custom_container category-1-style-container">

         <div class="row sh_page">
            <div id="cat_style1_carousel" class="owl-carousel owl-theme ">

               <div class="item">
                     <div class="col-12">
                        <div class="cats_effect">
                        <div class="pro_image">
                           <a href="shop-left-sidebar.html"><img src="assets/img/category/category_1.jpg" class=" mx-auto d-block img-fluid rounded-circle p-3 bg-light" alt="category_1"></a>
                        </div>                     
                        <div class="main_text mt-3">                          
                           <p class="text-center pro-heading my-2 text-uppercase"><a class="text-muted" href="shop-left-sidebar.html">Weed</a></p>                                               
                        </div>
                     </div>
                     </div>
                  </div>
                  ...
                  <div class="item">
                     <div class="col-12">
                        <div class="cats_effect">
                        <div class="pro_image">
                           <a href="shop-left-sidebar.html"><img src="assets/img/category/category_2.jpg" class=" mx-auto d-block img-fluid rounded-circle p-3 bg-light" alt="category_2"></a>
                        </div>                     
                        <div class="main_text mt-3">                          
                           <p class="text-center pro-heading my-2 text-uppercase"><a class="text-muted" href="shop-left-sidebar.html">cannabis</a></p>                                               
                        </div>
                     </div>
                     </div>
                  </div>
                  ...
                  <div class="item">
                     <div class="col-12">
                        <div class="cats_effect">
                        <div class="pro_image">
                           <a href="shop-left-sidebar.html"><img src="assets/img/category/category_4.jpg" class=" mx-auto d-block img-fluid rounded-circle p-3 bg-light" alt="category_4"></a>
                        </div>                     
                        <div class="main_text mt-3">                          
                           <p class="text-center pro-heading my-2 text-uppercase"><a class="text-muted" href="shop-left-sidebar.html">Raisin </a></p>                                               
                        </div>
                     </div>
                     </div>
                  </div>
                  ...
                  <div class="item">
                     <div class="col-12">
                        <div class="cats_effect">
                        <div class="pro_image">
                           <a href="shop-left-sidebar.html"><img src="assets/img/category/category_6.jpg" class=" mx-auto d-block img-fluid rounded-circle p-3 bg-light" alt="category_6"></a>
                        </div>                     
                        <div class="main_text mt-3">                          
                           <p class="text-center pro-heading my-2 text-uppercase"><a class="text-muted" href="shop-left-sidebar.html">audio</a></p>                                                
                        </div>
                     </div>
                     </div>
                  </div>
                  ...
                  <div class="item">
                     <div class="col-12">
                        <div class="cats_effect">
                        <div class="pro_image">
                           <a href="shop-left-sidebar.html"><img src="assets/img/category/category_7.jpg" class=" mx-auto d-block img-fluid rounded-circle p-3 bg-light" alt="category_7"></a>
                        </div>                     
                        <div class="main_text mt-3">                          
                           <p class="text-center pro-heading my-2 text-uppercase"><a class="text-muted" href="shop-left-sidebar.html">Indoor  </a></p>                                               
                        </div>
                     </div>
                     </div>
                  </div>
                  ...
                  <div class="item">
                     <div class="col-12">
                        ...
                        <div class="main_text mt-3">                          
                           <p class="text-center pro-heading my-2 text-uppercase"><a class="text-muted" href="shop-left-sidebar.html">Pigmyweeds</a></p>                                                
                        </div>
                     </div>
                     </div>
                  </div>
                  ...
                  <div class="item">
                     <div class="col-12">
                        ...
                        <div class="main_text mt-3">                          
                           <p class="text-center pro-heading my-2 text-uppercase"><a class="text-muted" href="shop-left-sidebar.html">Fragrant</a></p>                                               
                        </div>
                     </div>
                     </div>
                  </div>
