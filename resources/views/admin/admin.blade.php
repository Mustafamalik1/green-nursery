...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="assets1/images/favicon.svg" type="image/x-icon">

    <!-- font css -->
    <link rel="stylesheet" href="assets1/fonts/feather.css">
    <link rel="stylesheet" href="assets1/fonts/fontawesome.css">
    <link rel="stylesheet" href="assets1/fonts/material.css">

    <!-- vendor css -->
    <link rel="stylesheet" href="assets1/css/style.css" id="main-style-link">
...
<body class="">
	...
	<div class="pc-mob-header pc-header">
		<div class="pcm-logo">
			<img src="assets1/images/logo.svg" alt="" class="logo logo-lg">
		</div>
...
<!-- [ Main Content ] end -->
    ...
    <script src="assets1/js/plugins/feather.min.js"></script>
    <script src="assets1/js/pcoded.min.js"></script>
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.12.0/highlight.min.js"></script> -->
    <!-- <script src="assets1/js/plugins/clipboard.min.js"></script> -->
    <!-- <script src="assets1/js/uikit.min.js"></script> -->
