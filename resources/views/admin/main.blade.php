		...
		<div class="header-wrapper">
			...
			<div class="ml-auto">
				<ul class="list-unstyled">
					...
					<li class="dropdown pc-h-item">
						<a class="pc-head-link dropdown-toggle arrow-none mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
							<img src="assets1/images/user/avatar-2.jpg" alt="user-image" class="user-avtar">
							<span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover m-b-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>HeadPhone</td>
                                            <td><img src="assets1/images/widget/p1.jpg" alt="" class="img-20"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Iphone 6</td>
                                            <td><img src="assets1/images/widget/p2.jpg" alt="" class="img-20"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Jacket</td>
                                            <td><img src="assets1/images/widget/p3.jpg" alt="" class="img-20"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Sofa</td>
                                            <td><img src="assets1/images/widget/p4.jpg" alt="" class="img-20"></td>
                                            <td>
                                                <div><label class="badge bg-light-danger">Cancel</label></div>
                                            </td>
                                            <td>$85</td>
