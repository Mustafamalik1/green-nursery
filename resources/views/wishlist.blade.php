         ...
         <div class="sp_header bg-white p-3 ">
            <div class="container custom_container ">
               <div class="row ">
                  <div class="col-12 ">
                     <ul>
                        <li class="d-inline-block font-weight-bolder"><a href="{{ route('shop.redirect') }}">home</a></li>
                        <li class="d-inline-block hr_ font-weight-bolder"><a href="{{ route('shop.wishlist') }}">wishlist</a></li>
                     </ul>
                  </div>
               </div>
            </div>
